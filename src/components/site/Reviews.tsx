...
export const Reviews = () => {
  ...
  return (
    <section id="reviews" className="py-24 sm:py-32 relative bg-background">
      <div className="mx-auto max-w-5xl px-6">
        <div className="text-center mb-14">
          <div className="font-condensed text-flame tracking-widest mb-3">— REVIEWS</div>
          <h2 className="font-display text-4xl sm:text-6xl text-foreground">Loved by <span className="text-gradient-fire">thousands.</span></h2>
        ...
        <div className="relative">
          <div className="bg-card rounded-3xl p-8 sm:p-12 text-center border border-border">
            ...
            <p className="font-display text-2xl sm:text-3xl leading-snug mb-6 text-foreground">"{reviews[i].text}"</p>
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <button onClick={prev} className="bg-card rounded-full p-3 border border-border hover:bg-flame hover:text-primary-foreground transition-colors">
            ...
            <button onClick={next} className="bg-card rounded-full p-3 border border-border hover:bg-flame hover:text-primary-foreground transition-colors">
